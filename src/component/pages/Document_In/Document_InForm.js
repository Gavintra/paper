...
const Document_InForm = (props) => {
    ...
    useEffect(() => {
        if (props.currentId == '')
            ...
            setValues({
                ...props.documentInObjects[props.currentId]
            })
    }, [props.currentId, props.documentInObjects])
    ...
    const handleFormSubmit = e => {
        ...
        db.collection("paper_file_in").doc(docName).set({
            name: docName,
            doc_date: docDate,
...
export default Document_InForm;